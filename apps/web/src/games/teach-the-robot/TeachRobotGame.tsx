				...
				<aside className="lab-card p-5 flex flex-col justify-between h-full min-h-0 bg-white/85 border-white/70 shadow-sm rounded-3xl">
					<div className="space-y-4">
						...
						<div className="rounded-2xl bg-cream/60 border border-yellowLab/20 p-4 space-y-2 text-xs">
							<p className="font-bold text-ink flex items-center gap-2">
								<span className="grid h-5 w-5 place-items-center rounded-full bg-skyLab text-white font-black text-[10px]">
									1
								</span>
								Gán nhãn cho từng vật thể ở bên trái
							</p>
							<p className="font-bold text-ink flex items-center gap-2">
								<span className="grid h-5 w-5 place-items-center rounded-full bg-purpleLab text-white font-black text-[10px]">
									2
								</span>
								Nhấn "Huấn luyện Robot" để robot học
							</p>
							<p className="font-bold text-ink flex items-center gap-2">
								<span className="grid h-5 w-5 place-items-center rounded-full bg-greenLab text-white font-black text-[10px]">
									3
								</span>
						...
						{training && (
							<div className="space-y-2">
								<p className="text-xs font-black text-muted text-center animate-pulse">
					...
					{trained && (
						<div className="mt-4 space-y-3 border-t border-white/60 pt-3 relative flex-1 min-h-0 overflow-y-auto pr-1">
							...
							<button
								type="button"
								className="big-button w-full bg-cream border border-yellowLab/40 text-ink py-2 text-xs font-bold"
								onClick={resetLevel}
							>
