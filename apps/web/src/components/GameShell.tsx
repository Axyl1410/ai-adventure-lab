		...
		<main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-3 py-3 sm:px-4 sm:py-3.5">
			...
			<div className="mb-4 flex flex-wrap items-center justify-between gap-3">
				<div className="grid w-full grid-cols-2 items-center gap-2 sm:flex sm:w-auto sm:flex-wrap">
					<Link
						className="big-button min-h-11 bg-white/90 text-ink border border-white/60 shadow-sm hover:shadow-md py-2 px-3 text-xs sm:px-4 sm:text-sm"
						to="/"
					>
			...
			<section className="lab-card mb-4 flex flex-col gap-3 rounded-3xl border border-white/60 p-3 shadow-sm sm:p-4 md:flex-row md:items-center md:gap-4">
				<div className="flex items-center gap-3">
					...
					<div className="min-w-0">
						<div className="flex items-center gap-3">
							<h1 className="truncate text-lg font-black tracking-tight text-ink sm:text-xl">
								{title}
							</h1>
							{maxScore ? (
						...
						<p className="mt-0.5 line-clamp-2 text-xs font-bold text-muted sm:line-clamp-none">
							{subtitle}
						</p>
					</div>
				</div>
